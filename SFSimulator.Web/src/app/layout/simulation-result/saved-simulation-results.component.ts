...
@Component({
  selector: 'saved-simulation-results',
  templateUrl: './saved-simulation-results.component.html',
  styleUrls: ['./saved-simulation-results.component.scss']})
export class SavedResultsComponent {
