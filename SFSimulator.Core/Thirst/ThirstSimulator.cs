...
public class QuestOptions(QuestPriorityType Priority, decimal? HybridRatio)
{
    public QuestPriorityType Priority { get; set; } = Priority;
    public decimal? HybridRatio { get; set; } = HybridRatio;
}